        ...
        {isProviderConnected ? (
          <section>
            ...
            <div className={styles.infoText}>
              ...
              <a href="https://void.dev/symmetry" target="_blank" rel="noopener noreferrer">
                {t("symmetry-visit-providers-page-link")}
              </a>.
            </div>
            <div className={styles.infoText}>
              <b>{t("symmetry-permanent-connection-info")}</b>{" "}
              <a href="https://github.com/voiddotdev/symmetry-cli" target="_blank" rel="noopener noreferrer">
