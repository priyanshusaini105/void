...
export const EXTENSION_NAME = "@ext:rjmacarthy.void"
export const ASSISTANT = "assistant"
export const USER = "user"
export const TWINNY = "void"
...
export const URL_SYMMETRY_WS = "https://void.dev/ws"
export const TWINNY_PROVIDERS_FILENAME = "void-providers.json"
